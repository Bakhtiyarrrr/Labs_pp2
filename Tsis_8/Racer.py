...
class Coin:
    def __init__(self,screen,u,v,counter):
        self.screen = screen
        self.counter = counter
        self.u = u
        self.v = v
        self.image = pygame.image.load("Labs_pp2/Tsis_8/for_racer/coin.png")
        self.rect = self.image.get_rect(center = (self.u,self.v))
